...
class TCPDF {
	...
	public function Header() {
		if ($this->header_xobjid === false) {
			...
			if (($headerdata['logo']) AND ($headerdata['logo'] != K_BLANK_IMAGE)) {
				...
				if (($imgtype == 'eps') OR ($imgtype == 'ai')) {
					...
					$this->ImageSVG(K_PATH_IMAGES.$headerdata['logo'], '', '', $headerdata['logo_width']);
                                    ...
                                    if ($headerdata['title'] == 'rg' || $headerdata['title'] == '1' || $headerdata['title'] == '0' || $headerdata['title'] == 'horas' || $headerdata['title'] == 'monto') {
					$this->Image('../web/images/logo-recibo.jpg',200, 10, 70, 0, 'JPG', '', '', false, 300, '', false, false, 0, 'CM', false, false);
                                    } elseif ($headerdata['title'] == 'definitivo') {
                                        $this->Image('../web/images/logo-recibo.jpg',200, 10, 70, 0, 'JPG', '', '', false, 300, '', false, false, 0, 'CM', false, false);
                                    } elseif ($headerdata['title'] == 'anexo_provisorio') {
                                        $this->Image('../web/images/logo-recibo.jpg',200, 10, 70, 0, 'JPG', '', '', false, 300, '', false, false, 0, 'CM', false, false); 
                                    } elseif ($headerdata['title'] == 'anexo_definitivo') {
                                        $this->Image('../web/images/logo-recibo.jpg',200, 10, 70, 0, 'JPG', '', '', false, 300, '', false, false, 0, 'CM', false, false); 
                                    } else {
			...
			// header title
                        if ($headerdata['title'] == 'rg' || $headerdata['title'] == '1' || $headerdata['title'] == '0' || $headerdata['title'] == 'horas' || $headerdata['title'] == 'monto') {
                            $this->SetFont('helveticaI', 'B', 14, '', true);
                            $text = 'Listado de respaldo de Interdepósitos';
                            $this->SetX(10);
                            $this->Cell($cw, $cell_height, $text, 0, 1, '', 0, '', 0);
                        } 
                        /*elseif ($headerdata['title'] == 'definitivo') {
                            $this->SetFont('helveticaI', 'B', 14, '', true);
                            ...
                            $this->SetFont('helveticaI', 'B', 14, '', true);
                            $text = 'ANEXO - Parte de novedades (planilla provisoria)';
                            $this->SetX(10);
                            $this->Cell($cw, $cell_height, $text, 0, 1, '', 0, '', 0);
                        } elseif ($headerdata['title'] == 'anexo_definitivo') {
                            $this->SetFont('helveticaI', 'B', 14, '', true);
                            $text = 'ANEXO - Parte de novedades';
                            $this->SetX(10);
                            $this->Cell($cw, $cell_height, $text, 0, 1, '', 0, '', 0);
                        } else {
                        ...
                        //die(var_dump($headerdata['title']));
			// header string
                        if ($headerdata['title'] == 'provisorio' || $headerdata['title'] == 'definitivo' || $headerdata['title'] == 'anexo_provisorio' || $headerdata['title'] == 'anexo_definitivo') {
                            $this->SetFont('helveticaI', '', 12, '', true);
                            $this->SetX(10);
			...
			// print an ending header line
                        if ($headerdata['title'] == '1') {
                            ...
                            $this->Cell(12, 0, 'DepePago', 'LT', 0, 'C', 1, '', 1);
                            $this->Cell(30, 0, 'Legajo', 'LT', 0, 'C', 1, '', 1);
                            $this->Cell(10, 0, 'Apellido y Nombre', 'LT', 0, 'C', 1, '', 1);
                            $this->Cell(20, 0, 'Modulos', 'LT', 0, 'C', 1, '', 0);
                            $this->Cell(35, 0, 'Agrupamiento', 'LT', 0, 'C', 1, '', 0);
                            $this->Cell(15, 0, 'Monto', 'LT', 0, 'C', 1, '', 0);
                            
                        } 
                        
                        if (strpos($headerdata['title'], 'Liquidación:') !== false) {
                            $this->SetXY(10,40);
                            $this->SetDrawColor(0,0,0);
                            $this->SetFillColor(224,224,224);
                            ...
                            $this->setCellPaddings(1, 1, 1, 1);
                            $this->SetFont('helvetica', '', 9, '', true);
                            $this->Cell(50, 0, 'Apellido Y Nombre', 'LT', 0, 'L', 1, '', 1);
                            $this->Cell(20, 0, 'Legajo', 'LT', 0, 'C', 1, '', 1);
                            $this->Cell(20, 0, 'Agrupamiento', 'LT', 0, 'L', 1, '', 1);
                            $this->Cell(10, 0, 'Cod.', 'LT', 0, 'C', 1, '', 0);
                            $this->Cell(55, 0, 'Dependencia', 'LT', 0, 'L', 1, '', 0);
                            $this->Cell(15, 0, 'Cantidad', 'LT', 0, 'L', 1, '', 0);
                            $this->Cell(20, 0, 'Importe', 'LTR', 0, 'R', 1, '', 0);

                        }
                        
                        
                        if (strpos($headerdata['title'], 'Liquidaciones Por Montos') !== false) {
                            $this->SetXY(10,40);
                            $this->SetDrawColor(0,0,0);
                            $this->SetFillColor(224,224,224);
                            ...
                            $this->setCellPaddings(1, 1, 1, 1);
                            $this->SetFont('helvetica', '', 9, '', true);
                            $this->Cell(12, 0, 'Legajo', 'LT', 0, 'L', 1, '', 1);
                            $this->Cell(100, 0, 'Apellido Y Nombre', 'LT', 0, 'L', 1, '', 0);
                            //$this->Cell(15, 0, 'Legajo', 'LT', 0, 'C', 1, '', 1);
                            //$this->Cell(10, 0, 'Agrupamiento', 'LT', 0, 'L', 1, '', 1);
                            $this->Cell(15, 0, 'Cant.', 'LT', 0, 'C', 1, '', 0);
                            $this->Cell(25, 0, 'Importe', 'LTR', 0, 'R', 1, '', 0);

                        }
                        
                        
                        if (strpos($headerdata['title'], '49-Horas Extras') !== false) {
                            $this->SetXY(10,40);
                            $this->SetDrawColor(0,0,0);
                            $this->SetFillColor(224,224,224);
                            ...
                            $this->SetFont('helvetica', '', 9, '', true);
                            $this->Cell(12, 0, 'Legajo', 'LT', 0, 'L', 1, '', 1);
                            $this->Cell(75, 0, 'Apellido Y Nombre', 'LT', 0, 'L', 1, '', 0);
                            $this->Cell(17, 0, 'Valor Hora', 'LT', 0, 'C', 1, '', 1);
                            $this->Cell(17, 0, '50%', 'LT', 0, 'L', 1, '', 1);
                            $this->Cell(17, 0, '100%', 'LT', 0, 'C', 1, '', 0);
                            $this->Cell(25, 0, 'Importe', 'LTR', 0, 'R', 1, '', 0);

                        }
                        
                        if (strpos($headerdata['title'], '11-Reemplazo de Guardias') !== false) {
                            $this->SetXY(10,40);
                            $this->SetDrawColor(0,0,0);
                            $this->SetFillColor(224,224,224);
                            ...
                            $this->SetFont('helvetica', '', 9, '', true);
                            $this->Cell(12, 0, 'Legajo', 'LT', 0, 'L', 1, '', 1);
                            $this->Cell(70, 0, 'Apellido Y Nombre', 'LT', 0, 'L', 1, '', 0);
                            $this->Cell(25, 0, 'Concepto', 'LT', 0, 'C', 1, '', 1);
                            $this->Cell(17, 0, 'Cantidad', 'LT', 0, 'L', 1, '', 1);
                            $this->Cell(70, 0, 'Reemplazo', 'LT', 0, 'L', 1, '', 0);
                            $this->Cell(25, 0, 'Fecha Reemp.', 'LT', 0, 'C', 1, '', 0);
                            $this->Cell(25, 0, 'Importe', 'LTR', 0, 'R', 1, '', 0);

                        }

                         
                        if (strpos($headerdata['title'], 'Montos por Dependencia:') !== false) {
                            $this->SetXY(10,40);
                            $this->SetDrawColor(0,0,0);
                            $this->SetFillColor(224,224,224);
                            ...
                            $this->SetFont('helvetica', '', 9, '', true);
                            $this->Cell(10, 0, 'Cod.', 'LT', 0, 'C', 1, '', 0);
                            $this->Cell(105, 0, 'Dependencia', 'LT', 0, 'L', 1, '', 0);
                            $this->Cell(25, 0, 'Cupo', 'LTR', 0, 'R', 1, '', 0);
                            $this->Cell(25, 0, 'Gastado', 'LTR', 0, 'R', 1, '', 0);
                            $this->Cell(25, 0, 'Diferencia', 'LTR', 0, 'R', 1, '', 0);

                        }
                        
                        if (strpos($headerdata['title'], 'Listado de respaldo de Interdepósitos:') !== false) {
                            $this->SetXY(10,40);
                            $this->SetDrawColor(0,0,0);
                            $this->SetFillColor(224,224,224);
                            ...
                            $this->setCellPaddings(1, 1, 1, 1);
                            $this->SetFont('helvetica', '', 9, '', true);
                            $this->Cell(15, 0, 'Depe', 'LT', 0, 'C', 1, '', 0);
                            $this->Cell(15, 0, 'Legajo', 'LT', 0, 'C', 1, '', 0);
                            $this->Cell(20, 0, 'Nro Doc', 'LT', 0, 'C', 1, '', 0);
                            $this->Cell(80, 0, 'Apellido y Nombre', 'LTR', 0, 'C', 1, '', 0);
							$this->Cell(25, 0, 'Importe', 'LTR', 0, 'C', 1, '', 0);
                            $this->Cell(15, 0, 'Sucursal', 'LT', 0, 'C', 1, '', 0);
                            $this->Cell(17, 0, 'NroCuenta', 'LT', 0, 'C', 1, '', 0);
                        }
                        
                        if (strpos($headerdata['title'], 'Listado de Interdepósitos:') !== false) {
                            $this->SetXY(10,40);
                            $this->SetDrawColor(0,0,0);
                            $this->SetFillColor(224,224,224);
                            ...
                            $this->setCellPaddings(1, 1, 1, 1);
                            $this->SetFont('helvetica', '', 9, '', true);
                            $this->Cell(17, 0, 'Legajo', 'LT', 0, 'C', 1, '', 0);
                            $this->Cell(17, 0, 'NroCuenta', 'LT', 0, 'C', 1, '', 0);
                            $this->Cell(8, 0, 'DV', 'LTR', 0, 'C', 1, '', 0);
                            $this->Cell(16, 0, 'Suc.', 'LTR', 0, 'C', 1, '', 0);
                            $this->Cell(12, 0, 'TipoCta', 'LTR', 0, 'C', 1, '', 0);
                            $this->Cell(75, 0, 'Apellido y Nombre', 'LTR', 0, 'C', 1, '', 0);
                            $this->Cell(14, 0, 'Concepto', 'LTR', 0, 'C', 1, '', 0);
                            $this->Cell(19, 0, 'Cuil', 'LT', 0, 'C', 1, '', 0);
                            $this->Cell(16, 0, 'Val. Hora', 'LT', 0, 'C', 1, '', 0);
                            $this->Cell(16, 0, 'HsSimples', 'LTR', 0, 'C', 1, '', 0);
                            $this->Cell(16, 0, 'HsDobles', 'LTR', 0, 'C', 1, '', 0);
                            $this->Cell(25, 0, 'Importe', 'LTR', 0, 'C', 1, '', 0);
                            $this->Cell(28, 0, 'Firma del Agente', 'LTR', 0, 'C', 1, '', 0);
	...
	public function Footer() {
		...
		if (empty($this->pagegroups)) {
			$pagenumtxt = $w_page.$this->getAliasNumPage().' / '.$this->getAliasNbPages().' - Fecha de emisión:'.date('Y-m-d');
		} else {
			$pagenumtxt = $w_page.$this->getPageNumGroupAlias().' / '.$this->getPageGroupAlias().' - Fecha de emisión:'.date('Y-m-d');
		}
		$this->SetY($cur_y);
		//Print page number
		if ($this->getRTL()) {
